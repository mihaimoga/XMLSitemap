...
***Ask not what XMLSitemap can do for you - ask what you can do for XMLSitemap***
...
2. Include additional information such as:
    ...
    * XMLSitemap Debug-Info containing:
...
1. Respect existing XMLSitemap coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
